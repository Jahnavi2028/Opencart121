...
public class ExtentReportManager implements ITestListener
{
	...
	public ExtentTest test;    //creating test case entries and update sttaus of test methods
	...
	public void onStart(ITestContext testContext)
	{
		...
		*/
		...
		extent.setSystemInfo("Appliaction", "opencart");
		extent.setSystemInfo("Environment", "QA");
		extent.setSystemInfo("User Name", System.getProperty("user.name"));
		extent.setSystemInfo("Os", "Windows10");
		extent.setSystemInfo("Broser Name", "Chrome");
	...
	public void onTestSkipped(ITestResult result)
	{
		test=extent.createTest(result.getTestClass().getName());
		test.assignCategory(result.getMethod().getGroups());
		test.log(Status.SKIP, "Test Case Silpped is:"+ result.getName());
		test.log(Status.FAIL, result.getThrowable().getMessage());
	}
